...
与之前的版本类似，Kubernetes v1.30 版本引入了新的稳定、Beta 测试和 Alpha 测试的功能。。一贯交付高质量版本的承诺凸显了我们的开发周期实力和社区的活跃支持。
...
发布团队用这样的名称来感谢来自世界各地、各行各业的数千人一起构建出来 Kubernetes 社区和它的生态，并祝愿每一位构建 Kubernetes，发布 Kubernetes，保持 Kubernetes 集群健壮在线的大家能像主题标志里的「furries（毛茸茸）」和她家里的猫一样生活幸福，抱有可爱的心态。
