...
此版本包含 40 项改进。在这些改进功能中，有 10 项已晋升为稳定版，另外有 19 项正在进入 Beta 阶段，以及最后的 11 项已晋升为 Alpha 阶段。
...
- [KEP-4009 设备插件的API添加对 CDI 设备的支持, 允许设备插件提供方使用 CDI 定义容器化环境所需的修改](https://kep.k8s.io/4009)
